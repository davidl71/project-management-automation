...
class TestIntegrationWithAdvisors:
    ...
    def test_all_advisors_have_voice_mappings(self):
        ...
        for metric, info in METRIC_ADVISORS.items():
            ...
            has_voice = (
                advisor in ADVISOR_VOICES["elevenlabs"] or
                advisor in ADVISOR_VOICES["edge-tts"] or
                advisor in ADVISOR_VOICES["pyttsx3"] or
                "default" in ADVISOR_VOICES["elevenlabs"]  # Fall back to default
            )
