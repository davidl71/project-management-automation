...
TOOL_CATALOG = {
    ...
    "context": {
        ...
        "related_tools": ["discovery"],
        "recommended_model": "claude-haiku",
        "persona": "developer",
    },
    "discovery": {
        "hint": "Tool discovery. action=list|help. Unified tool discovery and help.",
        "category": "Workflow",
        "description": "Discovers and provides help for available tools",
    ...
    "task_analysis": {
        ...
        "category": "Task Management",
        "description": "Analyzes tasks: duplicates, tags, hierarchy",
        "outputs": ["Duplicate groups", "Tag analysis", "Hierarchy structure"],
        "inputs": {"action": "duplicates/tags/hierarchy"},
