...
> 💡 **AI Assistant Hint:** For up-to-date, version-specific documentation on Go, Python, use the Context7 MCP server by appending `use context7` to your prompts. For example:
> - "How do I use Go patterns? use context7"
> - "Show me Python examples use context7"
> - "Go Python best practices 2025 use context7"
>
